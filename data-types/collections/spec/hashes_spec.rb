...
RSpec.describe 'Hashes' do
  ...
  it 'test 8' do
    ...
    books.store("John Steinbeck", "Of Mice and Men")
    expected = {
  ...
  it 'test 12' do
    ...
    books.store(:John_Steinbeck, "Of Mice and Men")
    expected =  {
